...
module.exports = {
    VERSION: 'Amdibell 3.0.0v - Public Stable',
    ...
    WELCOME_LOGO: process.env.WELCOME_LOGO === undefined ? 'https://i.ibb.co/QP79fy2/LOGO.jpg' : process.env.WELCOME_LOGO,
    BYE_LOGO: process.env.BYE_LOGO === undefined ? 'https://i.ibb.co/QP79fy2/LOGO.jpg' : process.env.BYE_LOGO,
