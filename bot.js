                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*📵 දෝෂ වාර්තාව [AMDI_BELL] 📵*' + 
                                    ...
                                    '\n\n*මෙම දෝෂ logs ඔබගේ අංකය හෝ ප්‍රති පාර්ශ්වයේ අංකය අඩංගු විය හැකිය.* _කරුණාකර එය සමග සැලකිලිමත් වන්න!_' +
                                    '\n\n*උදව් සඳහා ඔබට අපගේ whatsapp support කණ්ඩායමට ලිවිය හැකිය.*' +
                                    '\n\n*මෙම පණිවිඩය ඔබගේ අංකයට ගොස් තිබිය යුතුය.* _(සුරකින ලද පණිවිඩ)_' +
                                    '\n\n*https://chat.whatsapp.com/J7EdUBd7E2OIsXOOeAHcuT ඔබට එය මෙම group යොමු කළ හැකිය.*\n\n' +
                                    '*සිදු වූ දෝෂය:* ```' + error + '```\n\n'
                                    , MessageType.text, {detectLinks: false});
                            } else {
                                await conn.sendMessage(conn.user.jid, '*📵 බොට් වාර්තාව [AMDI_BELL] 📵*' + 
                                    '\n*බොට් නිසි ලෙස ක්රියා කරයි.*'+
                                    '\n\n*Message logs ඔබගේ අංකය හෝ ප්‍රති පාර්ශ්වයේ අංකය අඩංගු විය හැකිය.* _කරුණාකර එය සමග සැලකිලිමත් වන්න!_' +
                                    '\n\n*උදව් සඳහා ඔබට අපගේ whatsapp support කණ්ඩායමට ලිවිය හැකිය.*' +
                                    '\n\n_(සුරකින ලද පණිවිඩ)_' +
                                    '\n\n*ඔබේ bot සඳහා යම් උදව්වක් අවශ්‍ය නම්, https://chat.whatsapp.com/J7EdUBd7E2OIsXOOeAHcuT*\n\n' +
                                    '*Report:* ```' + error + '```\n\n'
                                    , MessageType.text);
                             } else {
                                 await conn.sendMessage(conn.user.jid, '*🉐 කණගාටුයි, මට මෙම දෝෂය කියවිය නොහැක! 🉐*' +
                                        '\n_ඔබට උදව් සඳහා අපගේ support කණ්ඩායම් වෙත ලිවිය හැකිය._'
                                        , MessageType.text
