                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [AMDI_BELL] ⚜️*\n\n' + 
                                    ...
                                    '\n_https://chat.whatsapp.com/JrWPuJw2pEgKsiRONOhniw ඔබට එය මෙම group යොමු කළ හැකිය._\n\n' +
                                    '*සිදු වූ දෝෂය:* ```' + error + '```\n\n'
                                ...
                                await conn.sendMessage(conn.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [AMDI_BELL] ⚜️*\n' + 
                                    ...
                                    '\n_ඔබේ bot සඳහා යම් උදව්වක් අවශ්‍ය නම්, https://chat.whatsapp.com/JrWPuJw2pEgKsiRONOhniw_\n\n' +
                                    '*Report:* ```' + error + '```\n\n'
                                    , MessageType.text);
                            }
                        }
