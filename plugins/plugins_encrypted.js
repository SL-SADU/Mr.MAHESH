...
const encrypt = require('amdibell-npm');
...
Sending build context to Docker daemon  2.932MBStep 1/7 : FROM kgamdaofficial/Amdibell:latest
latest: Pulling from kgamdaofficial/Amdibell
