...
if (Config.WORKTYPE == 'private') {
    Asena.applyCMD({ pattern: 'info', fromMe: true, desc: Lang.INFO_DESC, deleteCommand: false}, async (message, match) => { 
    ...
    Asena.applyCMD({ pattern: 'info', fromMe: false, desc: Lang.INFO_DESC}, async (message, match) => { 
